            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="mt-1 text-muted hover:text-ink shrink-0 p-1">
                    <ChevronDown className={`h-4 w-4 transition-transform duration-300 ${isExpanded ? 'rotate-180 text-amber' : ''}`} />
                  </div>
                </button>
