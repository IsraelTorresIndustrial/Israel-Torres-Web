            ...
            >
              <div>
                <div className="flex items-center justify-between">
                  <span className="grid h-10 w-10 place-items-center rounded-xl bg-brand-blue/20 text-brand-blue">
                    <GraduationCap className="h-5 w-5" />
                  </span>
                  <span className="rounded-full bg-navy-800 px-3 py-1 font-mono text-[8px] uppercase font-bold text-slate-300 border border-navy-700">
                    {item.note}
                  </span>
                </div>
