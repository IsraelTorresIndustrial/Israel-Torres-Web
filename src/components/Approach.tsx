import { ArrowDown, Sparkles, AlertCircle, HelpCircle, Layers } from 'lucide-react';
  ...
  return (
    <section id="enfoque" className="relative overflow-hidden bg-canvas py-20 md:py-24 border-b border-line/60">
      ...
      <div className="relative mx-auto max-w-[1240px] px-5 md:px-8">
        ...
        {/* Microhistoria visual en 3 actos */}
        <div className="mt-14 grid gap-4 md:grid-cols-3">
          {/* Paso 1: Fricción */}
          <div className="rounded-2xl border border-line bg-paper p-7 shadow-sm flex flex-col justify-between">
            <div>
              ...
              <p className="mt-4 text-sm leading-relaxed text-muted italic bg-canvas p-3 rounded-xl border border-line">
                {approachStory.step1.quote}
              </p>
            </div>
            <div className="mt-6 pt-4 border-t border-line/60 flex items-center gap-2 text-xs font-mono text-muted">
              <span>Identificar el dolor real</span>
            </div>
          </div>

          {/* Paso 2: Pregunta / Hipótesis */}
          <div className="rounded-2xl border border-cognac/30 bg-amber/[0.04] p-7 shadow-sm flex flex-col justify-between">
            <div>
              ...
              <p className="mt-4 text-sm leading-relaxed text-ink/80 font-medium bg-paper p-3 rounded-xl border border-cognac/20">
                {approachStory.step2.question}
              </p>
            </div>
            <div className="mt-6 pt-4 border-t border-cognac/20 flex items-center gap-2 text-xs font-mono text-amber font-semibold">
              <span>Formular la hipótesis</span>
            </div>
          </div>

          {/* Paso 3: Construir */}
          <div className="rounded-2xl border border-line bg-ink text-white p-7 shadow-md flex flex-col justify-between">
            <div>
              ...
              <p className="mt-4 text-sm leading-relaxed text-white/70 bg-white/[0.04] p-3 rounded-xl border border-white/10">
                {approachStory.step3.outcome}
              </p>
            </div>
            <div className="mt-6 pt-4 border-t border-white/10 flex items-center gap-2 text-xs font-mono text-cyan">
              <Sparkles className="h-3.5 w-3.5" />
              <span>Validar con un prototipo real</span>
            </div>
          </div>
        </div>
      </div>
