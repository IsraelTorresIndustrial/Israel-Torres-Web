...
export function Approach() {
  ...
  return (
    <section id="enfoque" className="relative overflow-hidden bg-canvas py-20 md:py-28 border-b border-line/60">
      <div className="dot-grid absolute inset-0 opacity-25 pointer-events-none" aria-hidden="true" />
      
      {/* Halo de fondo sutil */}
      <div className="absolute -left-24 top-1/2 -translate-y-1/2 h-[380px] w-[380px] rounded-full bg-electric/10 blur-[130px] pointer-events-none" aria-hidden="true" />
      <div className="absolute -right-24 bottom-10 h-[380px] w-[380px] rounded-full bg-cognac/10 blur-[130px] pointer-events-none" aria-hidden="true" />
      ...
      <div className="relative mx-auto max-w-[1240px] px-5 md:px-8">
        ...
        {/* 3 Bloques limpios con flujo natural */}
        <div className="mt-14 grid gap-5 md:grid-cols-3">
          {/* Bloque 1: Fricción */}
          <article className="card-lift rounded-2xl border border-line bg-paper p-7 shadow-sm flex flex-col justify-between">
            <div>
          ...
          {/* Bloque 2: Hipótesis & Pregunta */}
          <article className="card-lift rounded-2xl border border-cognac/30 bg-amber/[0.04] p-7 shadow-sm flex flex-col justify-between">
            <div>
          ...
          {/* Bloque 3: Construcción & Solución */}
          <article className="card-lift rounded-2xl border border-line bg-ink text-white p-7 shadow-md flex flex-col justify-between">
            <div>
